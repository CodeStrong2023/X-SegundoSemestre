/*
Ejercicio1: Leer 5 numeros por teclado, almacenarlos en un arreglo 
y realizar la media de los numeros positivos, la media de los 
...
public class Ejercicio3 {
     public static void main(String[] args){
        ...
        int conteo0=0,conteo_positivos=0;
